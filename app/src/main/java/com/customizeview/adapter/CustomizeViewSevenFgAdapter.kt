...
import com.customizeview.fragment.CustomizeViewSevenFragment
import com.customizeview.fragment.CustomizeViewSixFragment
import java.util.ArrayList

class CustomizeViewSevenFgAdapter : FragmentStatePagerAdapter{

    private var mTitles : ArrayList<String> = ArrayList()
    private var mFragments : ArrayList<CustomizeViewSevenFragment> = ArrayList()
    ...
    fun destory(){
        if (mFragments.isNotEmpty()){
            for (fragment: CustomizeViewSevenFragment in mFragments){
                fragment.onDestroy()
            }
        }
    }
    ...
    fun add(item : String){
        ...
        mFragments.add(CustomizeViewSevenFragment().newInstance(item))
    }
